  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute flex top-0 right-0 py-[15px] px-2 rounded-full border-none hover:bg-[#ffffff30] opacity-0 group-hover:opacity-100 transition-all duration-[0.5s] menu-icon`}
      >
